...
export type IntersectionType = {
  ...
  kind: 'intersection',
  types: Array<Type>,
  // Filled in during validation -- this is the flattened object type
  // containing all of the relevant fields.
...
export type Babel$Node = {loc: Babel$Range};
export type Babel$Range = {start: Babel$Location, end: Babel$Location};
export type Babel$Location = {line: number};

export interface TransportT {
